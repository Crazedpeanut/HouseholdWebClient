...
var IMAGE: JournalImage = new JournalImage(0, "http://thumb1.shutterstock.com/display_pic_with_logo/2117717/285854987/stock-photo-food-table-healthy-delicious-organic-meal-concept-285854987.jpg", "");

var ENTRIES: JournalEntry[] = [
  new JournalEntry(0, "Entry Zero", ENTRY_TEXT, "2003-06-20T23:23:00.003Z", [IMAGE]),
  new JournalEntry(1, "Entry One", ENTRY_TEXT, "2003-06-20T23:23:00.003Z", [IMAGE]),
  new JournalEntry(2, "Entry Two", ENTRY_TEXT, "2003-06-20T23:23:00.003Z", [IMAGE])
];

export var MockJournal: Journal = new Journal(0, ENTRIES);